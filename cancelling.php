...
if (isset($_POST['cancelling'])){
    ...
    if (mysqli_query($conn,$sql)) {
        $_SESSION['cancel']="<div class=success>Appointment succesfully cancelled.</div><p class='marginleft'>Click <a href='appointments.php'>here</a> to go back to my appointments</p>";
    } else {
